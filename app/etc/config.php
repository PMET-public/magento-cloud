...
return [
    'modules' => [
        ...
        'MagentoEse_B2BB2CSampleData' => 1,
        'MagentoEse_B2BCatalogSampleData' => 1,
        'MagentoEse_B2bAdminConfigurations' => 1,
        'MagentoEse_B2BMilwaukeeSampleData' => 1,
        'MagentoEse_B2BLegrandSampleData' => 1,
        'MagentoEse_B2BPhilipsSampleData' => 1,
        'MagentoEse_B2BSiemensSampleData' => 1,
        'MagentoEse_B2BMiscSampleData' => 1,
        'MagentoEse_SalesSampleData' => 1,
        'MagentoEse_B2BCompanySampleData' => 1,
        'MagentoEse_B2BSharedCatalogSampleData' => 1,
        'MagentoEse_B2BPricingSampleData' => 1,
        'MagentoEse_MyAccountWidget' => 1,
        ...
        'MagentoEse_SaasDataManagement' => 1,
        'MagentoEse_B2BOrderSampleData' => 1,
        'MagentoEse_ThemeCustomizer' => 1,
        'MagentoEse_VerticalDataAuto' => 1,
        'MagentoEse_VerticalDataGrocery' => 1,
        'MagentoEse_VerticalDataHealthBeauty' => 1,
