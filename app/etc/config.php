...
return [
    'modules' => [
        ...
        'MagentoEse_CustomerSampleData' => 1,
        'Example_PageBuilderExtensionText' => 1,
        ...
        'MagentoEse_InStorePickup' => 1,
        'MagentoEse_DataInstallGraphQl' => 1,
        'MagentoEse_InStorePickupSampleData' => 1,
        'MagentoEse_InstallationOverrides' => 1,
        'MagentoEse_LookBook' => 1,
        ...
        'MagentoEse_VeniaProductInstall' => 1,
